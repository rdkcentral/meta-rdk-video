...
SRC_URI = "git://github.com/rdkcentral/rdk-apparmor-profiles.git;protocol=ssh;branch=test-auto-srcrev;destsuffix=git/rdk-apparmor-profiles;name=rdk-apparmor-profiles"
