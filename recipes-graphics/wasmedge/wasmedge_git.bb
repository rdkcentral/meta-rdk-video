...
DEPENDS = "boost fmt spdlog"

# Fetch WASMEdge 0.13.5 release tag
SRC_URI = "git://github.com/WasmEdge/WasmEdge.git;branch=master"
...
do_install() {
    ...
    # Install wasmedge CLI (interpreter mode - AOT/JIT disabled)
...
FILES:${PN}-dev   += "${libdir}/pkgconfig/wasmedge.pc"
