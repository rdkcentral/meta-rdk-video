...
SRC_URI = "${CMF_GITHUB_ROOT}/rdkNativeScript;${CMF_GITHUB_SRC_URI_SUFFIX};branch=topic/RDKEMW-0"

#Release 1.0.1
SRCREV = "603e966ffbed69e761350809206632fbf640eefc"
...
EXTRA_OECMAKE += " -DENABLE_AAMP_JSBINDINGS_STATIC=FF"
