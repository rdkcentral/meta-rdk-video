...
SRCREV = "bf9ced0edd2152706f05da6546f9671ce3768e2b"
...
do_install:append() {
    ...
    install -d /opt
    install -m 0755 ${WORKDIR}/resource_monitor_runq_latency.sh /opt/resource_monitor_runq_latency.sh
    install -m 0755 ${WORKDIR}/perf.sh /opt/perf.sh
