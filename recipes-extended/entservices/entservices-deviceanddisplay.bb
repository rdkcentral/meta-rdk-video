...
PACKAGECONFIG[powermanager]         = "-DPLUGIN_POWERMANAGER=ON,-DPLUGIN_POWERMANAGER=OFF,iarmbus rfcapi virtual/vendor-deepsleepmgr-hal virtual/vendor-pwrmgr-hal,iarmbus rfcapi"
