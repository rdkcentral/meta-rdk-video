...
namespace Plugin {
    ...
    public:
        ...
        uint32_t StartCapture(const uint32_t interval, const IResourceMonitor::CaptureMode captureMode) override
        {
        ...
        uint32_t GetCurrentUsage(const string& processPrefix, const IResourceMonitor::MeasurementType measurementType) override
        {
    ...
    private:
        ...
        public:
            explicit MemAndCpuMonitor(const string& defaultStoragePath, ResourceMonitorImplementation& parent)
                ...
                , _jobIsFirstRun(true)
                , _captureMode(IResourceMonitor::CaptureMode::NONE)
            ...
            bool Start(const uint32_t interval, const IResourceMonitor::CaptureMode captureMode, const std::vector<string>& processPrefixes)
            {
                ASSERT(interval > 0);
                _stateGuard.Lock();
                bool result = false;
                ...
                switch (_captureMode) {
                case IResourceMonitor::CaptureMode::NONE:
                    break;
                case IResourceMonitor::CaptureMode::LIVE:
                    result = true;
                    _job.Submit();
                    break;
                case IResourceMonitor::CaptureMode::SUMMARY:
                case IResourceMonitor::CaptureMode::MIXED:
            ...
            bool Stop()
            {
                ...
                if (IResourceMonitor::CaptureMode::NONE == _captureMode) {
                    TRACE(Trace::Warning, (_T("Can not stop data capture. No active acquisition session.")));
                    return result;
                }

                if ((IResourceMonitor::CaptureMode::SUMMARY == _captureMode) || (IResourceMonitor::CaptureMode::MIXED == _captureMode)) {
            ...
            bool GetCurrentUsage(const string& processPrefix, const IResourceMonitor::MeasurementType measurementType)
            {
                _stateGuard.Lock();
                bool result = false;
                ...
                _captureMode = IResourceMonitor::CaptureMode::LIVE;
            ...
            void ProcessWorker(const Core::ProcessInfo& process)
            {
                ...
                if (_isCurrentUsageMode) {
                    ...
                    sample = GetProcessData(process, IResourceMonitor::MeasurementType::ALL);
                }
            ...
            {
                if ((IResourceMonitor::CaptureMode::LIVE == _captureMode) || (IResourceMonitor::CaptureMode::MIXED == _captureMode)) {
        ...
        private:
            ...
            bool _jobIsFirstRun;
            IResourceMonitor::CaptureMode _captureMode;
            bool _isCaptureInProgress;
            bool _isCurrentUsageMode;
            IResourceMonitor::MeasurementType _measurementType;
            ResourceMonitorImplementation& _parent;
            ...
            string GetProcessData(const Core::ProcessInfo& process, IResourceMonitor::MeasurementType measurementType)
            {
                string result;
                ...
                case IResourceMonitor::MeasurementType::ALL: {
                ...
                case IResourceMonitor::MeasurementType::ALLMEMORY: {
                    keys = { "time", "name", "pid", "cpids", "uss", "pss", "rss", "totalRam", "freeRam", "availableRam", "command" };
                    break;
                }
                case IResourceMonitor::MeasurementType::ALLCPU: {
                    keys = { "time", "name", "pid", "cpids", "userTotalCpu", "systemTotalCpu", "cpuLoad", "cpuLoadAvg1m", "cpuLoadAvg5m", "cpuLoadAvg15m", "command" };
                    break;
                }
                case IResourceMonitor::MeasurementType::MEMORYUSS: {
                    keys = { "time", "name", "pid", "cpids", "uss", "command" };
                    break;
                }
                case IResourceMonitor::MeasurementType::MEMORYPSS: {
                    keys = { "time", "name", "pid", "cpids", "pss", "command" };
                    break;
                }
                case IResourceMonitor::MeasurementType::MEMORYRSS: {
                    keys = { "time", "name", "pid", "cpids", "rss", "command" };
                    break;
                }
                case IResourceMonitor::MeasurementType::MEMORYRAMFREE: {
                    keys = { "time", "name", "pid", "cpids", "freeRam", "command" };
                    break;
                }
                case IResourceMonitor::MeasurementType::MEMORYRAMTOTAL: {
                    keys = { "time", "name", "pid", "cpids", "totalRam", "command" };
                    break;
                }
                case IResourceMonitor::MeasurementType::MEMORYRAMAVAILABLE: {
                    keys = { "time", "name", "pid", "cpids", "availableRam", "command" };
                    break;
                }
                case IResourceMonitor::MeasurementType::CPULOADTOTAL: {
                    keys = { "time", "name", "pid", "cpids", "cpuLoad", "command" };
                    break;
                }
                case IResourceMonitor::MeasurementType::CPULOADTOTALUSER: {
                    keys = { "time", "name", "pid", "cpids", "userTotalCpu", "command" };
                    break;
                }
                case IResourceMonitor::MeasurementType::CPULOADTOTALSYSTEM: {
                    keys = { "time", "name", "pid", "cpids", "systemTotalCpu", "command" };
                    break;
                }
                case IResourceMonitor::MeasurementType::NONE:
