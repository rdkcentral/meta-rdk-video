...
SRCREV = "2283d669d5129b6f168c6790263d9bf675565c64"
...
PACKAGECONFIG[lifecyclemanager]       = "-DPLUGIN_LIFECYCLE_MANAGER=ON,-DPLUGIN_LIFECYCLE_MANAGER=OFF,entservices-apis,entservices-apis"
PACKAGECONFIG[appmanager]       = "-DPLUGIN_APPMANAGER=ON,-DPLUGIN_APPMANAGER=OFF,entservices-apis,entservices-apis"
PACKAGECONFIG[packagemanager]       = "-DPLUGIN_PACKAGE_MANAGER=ON,-DPLUGIN_PACKAGE_MANAGER=OFF,entservices-apis,entservices-apis"
