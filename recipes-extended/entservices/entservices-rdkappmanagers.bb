...
SRCREV = "f550321cc1575de5dc7dbbf5c79999175a457cd1"
...
PACKAGECONFIG[runtimemanager]       = "-DPLUGIN_RUNTIME_MANAGER=ON ${RUNTIMEMANAGER_PLUGIN_ARGS},-DPLUGIN_RUNTIME_MANAGER=OFF,entservices-apis iptables yaml-cpp,entservices-apis iptables"
