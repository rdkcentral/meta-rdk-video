...
DESCRIPTION = "Builds AIDL compiler, binder libs from linux_binder_idl, and the DeepSleep-oriented RDK HAL AIDL interfaces consumed by PowerManager."
...
do_install() {
    ...
    for aidl_target in ${AIDL_TARGET} ${AIDL_EXTRA_TARGETS}; do
        ...
        # =========
        # Install RDK HAL AIDL C++ headers for downstream consumers.
        # =========
...
stage_binder_link_libs() {
    ...
    # downstream consumers can link against -lbinder/-lutils/-llog/-lbase during recipe
