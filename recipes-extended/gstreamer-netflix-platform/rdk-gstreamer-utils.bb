...
DEPENDS:append = " virtual/vendor-rdk-gstreamer-utils-platform playready-cdm-rdk playready-cdm-rdk-netflix  virtual/vendor-secapi2-adapter "
RDEPENDS:${PN}:append = " gstreamer1.0 virtual/vendor-rdk-gstreamer-utils-platform playready-cdm-rdk playready-cdm-rdk-netflix "
...
CXXFLAGS += " -I${STAGING_INCDIR}/playready -I${STAGING_INCDIR}/rdk-playready -I${STAGING_INCDIR}/rdk-playready/inc -I${STAGING_INCDIR}/rdk-playready/oem/ansi/inc -I${STAGING_INCDIR}/rdk-playready/oem/common/inc -I${STAGING_INCDIR}/rdk-playready/oem/comcast -I${STAGING_INCDIR}/rdk-playready/base "
