...
SRCREV = "9a67a729b4d94f9a0ab0481ed059be4a63a3a6d2"
SRC_URI = "${CMF_GITHUB_ROOT}/rialto-gstreamer;protocol=${CMF_GIT_PROTOCOL};branch=MediaPipelineCapabilitiesNewConfig"
