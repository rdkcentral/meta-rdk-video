...
#Mahesh DEPENDS:append:client = " virtual/mfrlib"
#Mahesh DEPENDS:append = " virtual/mfrlib"
#Mahesh DEPENDS:append = " virtual/vendor-devicesettings-hal "
###Mahesh DEPENDS:append = " virtual/vendor-deepsleepmgr-hal virtual/vendor-pwrmgr-hal "
