...
SRCREV = "e2d44b474e9f9d9866b7ed7cd5679396a42bfcbf"
...
do_install() {
	...
	install -m 0755 ${S}/etc/99-default-link-local.conf ${D}${sysconfdir}/NetworkManager/conf.d/99-default-link-local.conf
