...
# Tip of the branch on May 07, 2026
SRCREV = "67826a1434ae2351c73a320e989027c77843b5d1"
...
EXTRA_OECMAKE += " \
  ...
  -DWPE_VERSION_MICRO_SUFFIX=${@'%02d%02d' % (int((d.getVar('PV').split('.') + ['0'])[2]), int(d.getVar('PR').replace('r', '')))} \
"
