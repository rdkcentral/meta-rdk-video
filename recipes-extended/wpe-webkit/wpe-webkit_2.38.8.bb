...
EXTRA_OECMAKE:append = " ${@bb.utils.contains('DISTRO_FEATURES', 'bundle_browser_widget', ' -DCMAKE_INSTALL_RPATH=${WPE_LIB_RUNPATH} -DLD_SUPPORTS_DISABLE_NEW_DTAGS=OFF', '', d)}"
SYSROOT_DIRS:append = " ${@bb.utils.contains('DISTRO_FEATURES', 'bundle_browser_widget', ' ${libexecdir}', '', d)}"
