...
EXTRA_OECMAKE:remove:xione-uk = "-DCMAKE_DS_EVENT_SUPPORTED=1"
...
CXXFLAGS:remove:xione-uk = "-I${STAGING_DIR_TARGET}${includedir}/rdk/ds"
...
# source tree; sharp-a60 uses a different AAMP source revision.
SRC_URI:append:xione-uk = " file://0001-DS-COMRPC-disable-libds-calls-in-AAMP-PlayerExternalsRdk.patch"
