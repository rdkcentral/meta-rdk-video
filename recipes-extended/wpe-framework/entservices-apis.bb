...
PV = "4.1.0"
PR = "r0"
SRCREV_entservices-apis = "6c9127969eaf3dc9dadbfa6df4384b0dbda5a07a"
...
SRC_URI = "${CMF_GITHUB_ROOT}/entservices-apis;${CMF_GITHUB_SRC_URI_SUFFIX};name=entservices-apis;branch=es1Test/JSONRPCBenchmark"
