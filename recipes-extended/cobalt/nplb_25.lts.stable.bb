...
SRC_URI += "file://25/change_test_data_download.patch"
...
do_download_testdata() {
    ...
    output_dir="${WORKDIR}/git/out/evergreen-arm-hardfp_devel/content/test/starboard/shared/starboard/player/testdata"
