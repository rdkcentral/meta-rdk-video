...
LARBOARD_SRCREV_DEV = "fccaee4b66a41952fa9274cfc939a37033b3caac"
...
PACKAGECONFIG[fb_rpc_v1]     = "rdk_enable_firebolt_legacy_rpc_v1=true,rdk_enable_firebolt_legacy_rpc_v1=false,"
PACKAGECONFIG[firebolt_lifecycle] = "rdk_enable_firebolt_lifecycle=true,rdk_enable_firebolt_lifecycle=false,"
PACKAGECONFIG[wpecryptography] = "rdk_enable_wpecryptography=true,rdk_enable_wpecryptography=false,wpeframework-clientlibraries"
PACKAGECONFIG[rdkservices]   = "rdk_enable_rdkservices_api=true,rdk_enable_rdkservices_api=false,wpeframework entservices-apis"
