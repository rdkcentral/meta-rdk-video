...
CFLAGS += " -DENABLE_RDKV_SUPPORT -DENABLE_PS_PROCESS_SEARCH -DFEATURE_SUPPORT_WEBCONFIG -DDCMAGENT -DUSE_SERIALIZED_MANUFACTURER_NAME -DPERSIST_LOG_MON_REF -DNTP_SYNC_INDICATION -DENABLE_RED_RECOVERY_SUPPORT"
